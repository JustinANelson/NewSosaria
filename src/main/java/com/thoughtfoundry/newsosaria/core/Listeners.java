...
import com.thoughtfoundry.newsosaria.events.eventprocessors.RoleButtonEventProcessor;
...
public class Listeners extends ListenerAdapter {
    ...
    public void onSlashCommandInteraction(@Nonnull SlashCommandInteractionEvent event) {
        ...
        debug(event.getName());
        NewSosaria.commandProcessor.process(event);
    }
    @Override
    ...
    public void onShutdown(@Nonnull ShutdownEvent event) {
        ...
        NewSosaria.jda.getPresence().setActivity(Activity.playing("Shutting Down"));
    }
    @Override
    ...
    public void onModalInteraction(@Nonnull ModalInteractionEvent event) {
        ...
        NewSosaria.modalEventProcessor.process(event);
    }
    @Override
    ...
    public void onGuildJoin(@Nonnull GuildJoinEvent event) {
        ...
        NewSosaria.db.checkGuildExists(event.getGuild());
    }
    @Override
